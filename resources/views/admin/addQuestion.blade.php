...
<hr>
<form method="post" action="{{url('upload_question_data')}}" enctype="multipart/form-data">
    @csrf
    <!-- Grid row -->
    <div class="form-row">
      <!-- Grid column -->
      <div class="col-md-6">
        ...
        <div class="md-form form-group">
          ...
          <input required type="text" class="form-control" name="aboutTitle" placeholder="Question Title">
