...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html"><img src="{{asset('assets/img/logo.png')}}"></a></h1>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="footer-links">
                  ...
                  <p>
                   {{ $c_item->adress}} <br>
                    <strong>Phone:</strong> +88 {{ $c_item->phone}}<br>
                    <strong>Email:</strong> {{ $c_item->email}}<br>
                  </p>
                  @endforeach
